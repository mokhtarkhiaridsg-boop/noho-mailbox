export function MailboxIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      {/* Flag pole */}
      <rect x="98" y="30" width="5" height="28" rx="2" fill="#3374B5" stroke="#1A1714" strokeWidth="2" />
      {/* Flag */}
      <rect x="96" y="26" width="14" height="9" rx="2.5" fill="#3374B5" stroke="#1A1714" strokeWidth="2" />
      {/* Heart on body */}
...
export function DeliveryTruckIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <rect x="78" y="36" width="14" height="10" rx="2" fill="#3374B5" opacity="0.3" stroke="#1A1714" strokeWidth="1.5" />

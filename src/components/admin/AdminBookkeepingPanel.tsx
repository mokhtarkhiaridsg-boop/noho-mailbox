    ...
    <div className="space-y-4">
      <div>
        <p className="text-[10px] font-black uppercase tracking-[0.2em]" style={{ color: `${NOHO_BLUE}B0` }}>
          ...
          Money · Bookkeeping export
        </p>
        <h2 className="text-xl font-black tracking-tight" style={{ color: NOHO_INK }}>Bookkeeping export</h2>
        <p className="text-[11px] mt-0.5" style={{ color: "rgba(45,16,15,0.55)" }}>
          Pull Square payments, POS sales, wallet movements, invoices, and renewals for any date range — as plain CSVs (Excel-friendly) or QuickBooks IIF for direct import. All exports are audit-logged.
        </p>
      </div>

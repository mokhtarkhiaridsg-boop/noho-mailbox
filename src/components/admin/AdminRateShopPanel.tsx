    ...
    <div className="space-y-4">
      <div>
        <p className="text-[10px] font-black uppercase tracking-[0.2em]" style={{ color: `${T.blue}B0` }}>
          ...
          Operations · Rate shop
        </p>
        <h2 className="text-xl font-black tracking-tight" style={{ color: T.ink }}>Carrier rate shopping</h2>
        <p className="text-[11px] mt-0.5" style={{ color: T.inkFaint }}>
          Type destination zip + weight → see USPS / UPS / FedEx / DHL side-by-side. Cheapest + fastest highlighted. Saved quotes get audit-logged so you can prove "we picked X over Y on May 8".
        </p>
      </div>

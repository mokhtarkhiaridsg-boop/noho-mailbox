      ...
      <div className="flex items-start justify-between gap-2 flex-wrap">
        <div>
          <p className="text-[10px] font-black uppercase tracking-[0.2em]" style={{ color: `${T.blue}B0` }}>
            ...
            Operations · Front-desk bell
          </p>
          <h2 className="text-xl font-black tracking-tight" style={{ color: T.ink }}>🛎️ Bell rings</h2>
        ...
        <a href="/bell" target="_blank" rel="noopener noreferrer"
          className="text-[11px] font-bold px-3 py-1.5 rounded-lg" style={{ background: T.surfaceAlt, color: T.inkSoft, border: `1px solid ${T.border}`, textDecoration: "none" }}>
          Open /bell ↗
        </a>
      </div>

    ...
    <div className="space-y-4">
      <div>
        <p className="text-[10px] font-black uppercase tracking-[0.2em]" style={{ color: `${T.blue}B0` }}>
          ...
          Operations · Locker auto-assign
        </p>
        <h2 className="text-xl font-black tracking-tight" style={{ color: T.ink }}>📦 Locker assignments</h2>
        <p className="text-[11px] mt-0.5" style={{ color: T.inkFaint }}>
          Members with a current `lockboxMonthPassUntil` get auto-assigned to the next free auto-enabled Lockbox + an SMS with their 6-digit PIN. Unclaimed assignments expire after 7 days and the locker frees up.
        </p>
      </div>

  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-bold border-2 border-[#1976FF] text-[#1976FF] hover:bg-[#1976FF]/10 transition-colors"
      >
            ...
            {error ? (
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
                  <div className="border-2 border-[#1976FF] rounded-xl w-[80%] h-24 opacity-80" />
                </div>
              </div>
            )}

    ...
    <div className="space-y-4">
      <div>
        <p className="text-[10px] font-black uppercase tracking-[0.2em]" style={{ color: `${T.blue}B0` }}>
          ...
          Money & Comms · Smart renewal cadence
        </p>
        <h2 className="text-xl font-black tracking-tight" style={{ color: T.ink }}>Renewal-reminder smart cadence</h2>
        <p className="text-[11px] mt-0.5" style={{ color: T.inkFaint }}>
          Each member&apos;s renewal-reminder lead time is learned from their iter-83 MailboxRenewal history. Last-minute renewers get nudged at 1-2d out; early birds at 14-21d. Falls back to fixed 7d for members without enough history.
        </p>
      </div>
